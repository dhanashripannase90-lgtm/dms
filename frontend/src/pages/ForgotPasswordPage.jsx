          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input className="input-premium" type="email" placeholder="name@company.com"
                required value={form.email} onChange={set("email")} disabled={otpSent} style={{ paddingLeft: "3rem" }} />
            </div>
          </div>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="input-premium" type={showPw ? "text" : "password"}
                    ...
                    value={form.newPassword} onChange={set("newPassword")} style={{ paddingLeft: "3rem", paddingRight: "3.5rem" }} />
