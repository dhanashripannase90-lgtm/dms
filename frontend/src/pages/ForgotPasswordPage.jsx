...
function ForgotPasswordPage() {
  ...
  return (
    <div className="auth-shell" style={{ position: "relative" }}>
      ...
      <div className="glass-panel animate-slide-up" style={{ width: "100%", maxWidth: "440px", padding: "clamp(1.5rem, 5vw, 3rem)", position: "relative", zIndex: 10, margin: "0 1rem" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "2rem" }}>
          <DmsLogo size={56} />
          <h1 style={{ fontSize: "clamp(1.5rem, 4vw, 2rem)", fontWeight: 800, marginTop: "1rem", marginBottom: "0.4rem", letterSpacing: "-1px", textAlign: "center" }}>Reset Password</h1>
          <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem", textAlign: "center" }}>Securely recover your account.</p>
        </div>

        {error && <div className="alert alert-error" style={{ marginBottom: "1.5rem", borderRadius: "12px", background: "rgba(239, 68, 68, 0.1)", border: "1px solid rgba(239, 68, 68, 0.2)" }}>{error}</div>}
        {success && <div className="alert alert-success" style={{ marginBottom: "1.5rem", borderRadius: "12px", background: "rgba(16, 185, 129, 0.1)", border: "1px solid rgba(16, 185, 129, 0.2)", color: "#10b981", padding: "1rem" }}>{success}</div>}
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input className="input-premium" type="email" placeholder="name@company.com"
                required value={form.email} onChange={set("email")} disabled={otpSent} style={{ paddingLeft: "2.8rem" }} />
            </div>
          </div>
          {otpSent && (
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input className="input-premium" type={showPw ? "text" : "password"}
                    ...
                    value={form.newPassword} onChange={set("newPassword")} style={{ paddingLeft: "2.8rem", paddingRight: "3rem" }} />
